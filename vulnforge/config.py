"""
VulnForge Configuration Management
...
# Base directory of the vulnforge package
...
FLASK_HOST = "0.0.0.0"
FLASK_PORT = 5000
FLASK_DEBUG = os.environ.get("VULNFORGE_DEBUG", "false").lower() == "true"
SECRET_KEY = os.environ.get("VULNFORGE_SECRET", "vulnforge-dev-key-change-in-prod")
