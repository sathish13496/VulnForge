"""
VulnForge Flask Web Application
...
from vulnforge.core.target import ScanStatus
from vulnforge.cve.matcher import CVEMatcher
...
logger = logging.getLogger("vulnforge.app")
