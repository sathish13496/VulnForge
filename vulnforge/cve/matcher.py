...
from vulnforge.core.target import Finding, Severity, FindingStatus, Service, Target
from vulnforge.cve.database import CVEDatabase
from vulnforge.cve.models import CVEEntry
from vulnforge.config import get_severity

logger = logging.getLogger("vulnforge.cve.matcher")
